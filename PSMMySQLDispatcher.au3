...
; Consts & Globals
;=======================================
Global Const $DISPATCHER_NAME = "MySQLDispatcher"
Global Const $CLIENT_EXECUTABLE = "C:\Program Files\MySQL\MySQL Workbench 8.0 CE\MySQLWorkbench.exe"
...
$ConnectionClientPID = Run($CLIENT_EXECUTABLE & " --query " & $TargetUsername & "@" & $TargetAddress)
...
Error(PSMGenericClient_PSMGetLastErrorString())
EndIf
WinWait ("Connect to MySQL Server")
Send ($TargetPassword)
Send ("{ENTER}")
;ControlSetText ("Connect to MySQL Server","","WindowsForms10.EDIT.app.0.1a0e24_r9_ad1",$TargetPassword)
;ControlClick ("Connect to MySQL Server","","WindowsForms10.BUTTON.app.0.1a0e24_r9_ad1")
